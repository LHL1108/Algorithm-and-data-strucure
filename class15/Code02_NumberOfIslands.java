...
/*
要求： 一个二维矩阵数组，里面得数字非0即1，上下左右方向同为1即可连成一片岛，求矩阵中岛的个数
思路：
    感染方法：每走一步，就把能感染的1变成0，这样后面碰到1直接加岛数
    并查集方法：涉及到连点成片的合并问题，考虑使用并查集，每走过一块地方就与左上可以合并的进行合并
备注：本题为leetcode原题, 测试链接：https://leetcode.com/problems/number-of-islands/  ,所有方法都可以直接通过
